...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_cpu_plots.setGeometry(QtCore.QRect(120, 10, 931, 511))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(-1, -1, 931, 511))
        ...
        self.frame_progress_bars.setGeometry(QtCore.QRect(120, 10, 931, 511))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(-1, -1, 931, 511))
        ...
        self.frame_cpu_extra_info.setGeometry(QtCore.QRect(119, 9, 931, 511))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(-1, -1, 931, 511))
        ...
        self.frame_memory_info = QtWidgets.QFrame(self.centralwidget)
        self.frame_memory_info.setGeometry(QtCore.QRect(119, 9, 931, 511))
        self.frame_memory_info.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_memory_info.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_memory_info.setObjectName("frame_memory_info")
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(self.frame_memory_info)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 0, 931, 511))
        ...
        self.frame_network_info = QtWidgets.QFrame(self.centralwidget)
        self.frame_network_info.setGeometry(QtCore.QRect(120, 9, 931, 511))
        self.frame_network_info.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_network_info.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_network_info.setObjectName("frame_network_info")
        self.verticalLayoutWidget_6 = QtWidgets.QWidget(self.frame_network_info)
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(0, -1, 931, 511))
        ...
        self.frame_processes_info = QtWidgets.QFrame(self.centralwidget)
        self.frame_processes_info.setGeometry(QtCore.QRect(120, 9, 931, 511))
        self.frame_processes_info.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_processes_info.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_processes_info.setObjectName("frame_processes_info")
        self.verticalLayoutWidget_7 = QtWidgets.QWidget(self.frame_processes_info)
        self.verticalLayoutWidget_7.setGeometry(QtCore.QRect(0, -1, 931, 511))
